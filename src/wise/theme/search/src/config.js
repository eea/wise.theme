  ...
  listingViewParams: {
    ...
    details: {
      ...
      sections: [
        ...
        {
          title: 'Further information',
          condition: (rec) => rec['Origin of the measure']?.raw === 'HD (Directive 92/43/EEC)' && rec['MeasureCode']?.startsWith('HDH'),
          fields: [
        ...
        {
          title: 'Further information',
          condition: (rec) => rec['Origin of the measure']?.raw === 'HD (Directive 92/43/EEC)' && rec['MeasureCode']?.startsWith('HDSP'),
          fields: [
            {field: 'Measure purpose', },
            {field: 'Measure type recommended to address E02 and/or E03', },
            {field: 'Measure location', },
