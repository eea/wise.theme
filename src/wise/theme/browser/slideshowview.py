...
from wise.theme.browser.interfaces import IEasySlideshowView
from wise.theme.browser.slideshowmanager import SlideshowManagerAdapter
from wise.theme.interfaces import ISlideshowFolder
from wise.theme.events import SlideshowCreatedEvent
from wise.theme.events import SlideshowRemovedEvent
from wise.theme.events import SlideshowWillBeCreatedEvent
from wise.theme.events import SlideshowWillBeRemovedEvent
    ...
    def enable(self):
        ...
        if 'Slideshow' not in [ac.title for ac in fol.listActions()]:
            fol.addAction("slideshowproperties",
                          ...
                          'wise.theme.interfaces.ISlideshowFolder')",
...
class SlideshowView(BrowserView):
    ...
    #     prefix = "wise.theme.browser.interfaces.IEasyslideshowConfiguration"
